...
class _BaseQueryApi:
    ...
    def __init__(
        self, influxdb_client, query_options: Incomplete | None = ...
    ) -> None: ...

class _BaseWriteApi:
    def __init__(
        self, influxdb_client, point_settings: Incomplete | None = ...
    ) -> None: ...
...
class _Configuration(Configuration):
    ...
    def update_request_header_params(
        self, path: str, params: dict[Incomplete, Incomplete]
    ): ...
